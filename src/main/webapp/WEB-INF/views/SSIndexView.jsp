...
<div class="wrap"> 
    <div class="main_content">
          <div class="index_main_content_down_block">
            <div class="index_main_content_down_left" style="border-right: 1px solid #FF9A00;">
              <p style="font-family: Microsoft JhengHei;font-size:19.5px;">
                最新消息 <font color="#FF9A00"><span class="glyphicon glyphicon-chevron-right"  aria-hidden="true"></span> </font>
              </p>
              <div style="padding:3%;">
              ...
              <a id="open_news"  style="font-family: Microsoft JhengHei; font-size:15px; color: red;" href="SS_Page_news">
                more...
                </a>
            ...
            <div class="index_main_content_down_right" style="border-left: 1px solid #FF9A00;">
              <p style="font-family: Microsoft JhengHei;font-size:19.5px;">
                考試日程 <font color="#FF9A00"><span class="glyphicon glyphicon-chevron-right " aria-hidden="true"></span> </font>
              </p>
              <div style="padding:3%;">
              <font style="font-family: Microsoft JhengHei; font-size:17px;">
              <table class="table">
              ...
              <a id="open_date"  style="font-family: Microsoft JhengHei; font-size:15px; color: red;" href="SS_Page_schedule">
                more...
                </a>
